...
import { AlertCircle, Lock, Mail, Radio } from 'lucide-react';
...
const LoginPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(apiErrorMessage(err, '/auth/login') || 'Invalid email or password');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="w-full max-w-md space-y-8 bg-card p-8 rounded-lg border border-border shadow-lg">
                <div className="text-center">
                    <div className="flex items-center justify-center gap-3 mb-4">
                        ...
                        <h2 className="text-2xl font-bold text-foreground">Asterisk AI Agent Gateway</h2>
                    </div>
                    <p className="mt-2 text-sm text-muted-foreground">
                        Sign in to manage your organization control plane
                    </p>
                </div>
